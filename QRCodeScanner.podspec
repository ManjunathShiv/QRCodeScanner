...
Pod::Spec.new do |s|
  ...
  s.author             = { "ManjuShiv" => "manjunath.k.85@gmail.com" }
  # Or just: s.author    = "ManjuShiv"
  # s.authors            = { "ManjuShiv" => "manjunath.k.85@gmail.com" }
  # s.social_media_url   = "http://twitter.com/ManjuShiv"
